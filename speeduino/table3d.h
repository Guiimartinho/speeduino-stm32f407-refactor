...
// ============================================================================
// MODULARIZED 3D TABLE SYSTEM
// ============================================================================
// New modular architecture with coordinator-based 3D table management
// All 3D table implementations preserved 100% in table3d files
// Coordinator provides unified API with documentation:
// - 3D tables (bilinear interpolation)
// - Axis compression (RPM/100, Load/2)
// - 2-level caching (bin + value)
// - Fixed-point math (QU1X8 format)
// ============================================================================
//
// Include modular table coordinator (optional - for future migration)
// For now, all 3D table code remains in table3d*.h/cpp files
